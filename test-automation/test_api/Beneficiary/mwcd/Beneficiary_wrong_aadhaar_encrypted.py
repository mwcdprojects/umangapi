...
class test_Beneficiary_registration:
    ...
    def test_registration(self):
        ...
        payload['AadharNo'] = encrypted_aadhaar1.decode('utf-8')+'1234567'
        payload['HusbandAadhaarNo'] = encrypted_husband_aadhaarno.decode('utf-8')+'1234567'
        ...
        assert response.json()['Benresp']['Errors'][0][
                   'ErrMsg'] == 'Beneficiary Aadhaar decryption error'
