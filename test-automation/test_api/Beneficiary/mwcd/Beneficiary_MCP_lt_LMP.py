...
class test_Beneficiary_registration:
    ...
    def test_registration(self):
        ...
        payload['DateOfMCPCard'] = "2019-12-12"
        ...
        assert response.json()['Benresp']['Errors'][0]['ErrMsg'] == "LMP Date must not exceed Date of Reg. of MCP card at AWC/Subcenter and Registration Date"
