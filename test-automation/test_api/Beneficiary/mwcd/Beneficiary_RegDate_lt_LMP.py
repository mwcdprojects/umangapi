...
class test_Beneficiary_registration:
    ...
    def test_registration(self):
        ...
        payload['BeneficiaryRegistrationDate'] = "2018-06-16"
        ...
        assert response.json()['Benresp']['Errors'][0]['ErrMsg'] == "Date of LMP must not exceed the Beneficiary Registration Date. Please enter the correct date."
