...
class test_change_password:
    ...
    def test_changepwd_invalid(self):
        ...
        assert response.json()['errormessage'] == "Password must be  between 8 and 14 characters and Must be a combination of letters,numbers and special characters"

if __name__ == '__main__':
    test_change_password().test_changepwd_invalid()
