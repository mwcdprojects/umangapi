...
class test_correction_q_invalid_userid:
    def __init__(self):
    ...
    def test_cq_invalid_userid(self):
        ...
        authdata = test_correction_q_invalid_userid().authtoken_userid()
        payload['LoginAuthToken'] = authdata['AuthToken']
        payload['UserId'] = authdata['UserId']+20
        endpoint = self.url
...
if __name__ == '__main__':
    test_correction_q_invalid_userid().test_cq_invalid_userid()
