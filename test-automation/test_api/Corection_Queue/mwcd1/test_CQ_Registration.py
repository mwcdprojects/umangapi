...
class test_correction_q_registration:
    def __init__(self):
    ...
    def test_cq_registration(self):
        ...
        authdata = test_correction_q_registration().authtoken_userid()
...
if __name__ == '__main__':
    test_correction_q_registration().test_cq_registration()
